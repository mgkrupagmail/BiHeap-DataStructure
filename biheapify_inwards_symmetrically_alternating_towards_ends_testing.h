/*
 * biheapify_inwards_symmetrically_alternating_towards_ends_testing.h
 *
 * The function MeasureBiHeapifyInwardsSymmetricallyAlternatingTowardsEndsProperties()
 *  calls BiHeapifyInwardsSymmetricallyAlternatingTowardsEnds() on a randomly
...
#ifndef BIHEAPIFY_INWARDS_SYMMETRICALLY_ALTERNATING_TOWARDS_ENDS_TESTING_H_
#define BIHEAPIFY_INWARDS_SYMMETRICALLY_ALTERNATING_TOWARDS_ENDS_TESTING_H_
...
#include "biheapify.h"
#include "biheapify_inwards_symmetrically_alternating_towards_ends.h"

template<class ValueType, typename size_type = std::size_t>
struct TestBiHeapifyInwardsSymmetricallyAlternatingTowardsEndsOnGivenSize {
  size_type N_;
  ...
  TestBiHeapifyInwardsSymmetricallyAlternatingTowardsEndsOnGivenSize(size_type N) : N_(N) {
  ...
  void RunBiHeapifyInwardsSymmetricallyAlternatingTowardsEnds() {
    BiHeapifyInwardsSymmetricallyAlternatingTowardsEnds(vec_.begin(), N_);
    total_num_test_runs_++;
  }

  void PerformTestWithBiHeapifyInwardsSymmetricallyAlternatingTowardsEnds(long double scale = 0.0l) {
    if (scale <= 0.0l)
      FillVecWithRandomNumbers();
    else
      FillVecWithRandomNumbersSizeScaledInterval(scale);
    RunBiHeapifyInwardsSymmetricallyAlternatingTowardsEnds();
    Analyze();
  }
  ...
  std::string GetDescriptionOfResult(bool include_start_of_description = true,
    ...
    if (num_times_left_median_was_emplaced_ == total_num_test_runs_)
      ave_num_times_left_median_was_emplaced = 1.0l;
    if (num_times_right_median_was_emplaced_ == total_num_test_runs_)
...
long double TestBiHeapifyInwardsSymmetricallyAlternatingTowardsEndsOnGivenSize<ValueType, size_type>::smallest_ever_num_elements_less_than_or_equal_ratio_ = 1.0l;
template<class ValueType, typename size_type>
long double TestBiHeapifyInwardsSymmetricallyAlternatingTowardsEndsOnGivenSize<ValueType, size_type>::smallest_ever_num_elements_greater_than_or_equal_ratio_ = 1.0l;
template<class ValueType, typename size_type>
long double TestBiHeapifyInwardsSymmetricallyAlternatingTowardsEndsOnGivenSize<ValueType, size_type>::smallest_ever_of_smaller_of_num_le_and_ge_ratios_ = 1.0l;
template<class ValueType, typename size_type>
size_type TestBiHeapifyInwardsSymmetricallyAlternatingTowardsEndsOnGivenSize<ValueType, size_type>::N_for_smallest_ever_of_smaller_of_num_le_and_ge_ = 1;
template<class ValueType, typename size_type>
size_type TestBiHeapifyInwardsSymmetricallyAlternatingTowardsEndsOnGivenSize<ValueType, size_type>::smaller_of_num_le_and_ge_for_smallest_ever_ = 1;
...
void MeasureBiHeapifyInwardsSymmetricallyAlternatingTowardsEndsProperties(size_type num_tests = (1u << 18),
  ...
  for (size_type N = N_start; N < N_one_past_end; ) {
    TestBiHeapifyInwardsSymmetricallyAlternatingTowardsEndsOnGivenSize<ValueType> test(N);
    test.verbose_ = false;
    std::cout << test.GetStartOfDescriptionOfResult(num_tests);
    std::cout.flush();
    for (std::size_t i = 0; i < num_tests; i++) {
      test.PerformTestWithBiHeapifyInwardsSymmetricallyAlternatingTowardsEnds();
    }
...
#endif /* BIHEAPIFY_INWARDS_SYMMETRICALLY_ALTERNATING_TOWARDS_ENDS_TESTING_H_ */
